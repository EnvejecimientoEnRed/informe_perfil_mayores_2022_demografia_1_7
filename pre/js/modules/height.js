...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '666px';
        document.getElementsByClassName('main')[0].style.height = '638px';
        ...
        let height = 638; //Altura total del main
